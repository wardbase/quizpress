	...
	return (
		<>
			<div className="wpProQuiz_results">
				...
				<p>
					{ correctNumber } of { questionCount } questions answered
					correctly.
				</p>
				<p className="wpProQuiz_points">
					You have reached { userPoint } of { totalPoint }, (
					{ round( ( userPoint / totalPoint ) * 100 ) }%)
				</p>
				<div className="ld-quiz-actions">
					<input
						className="wpProQuiz_button wpProQuiz_button_reShowQuestion"
						type="button"
						name="reShowQuestion"
					...
					/>
					<input
						className="wpProQuiz_button wpProQuiz_button_restartQuiz"
						type="button"
						name="restartQuiz"
						value="Restart Quiz"
						onClick={ () => {
